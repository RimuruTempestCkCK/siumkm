        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i><span class="nav-text">Kelola Data User</span>
                        </a>
                        <ul aria-expanded="false">
                            <!-- <li><a href="./table-basic.php" aria-expanded="false">Basic Table</a></li> -->
                            <li><a href="./kelola_data_user.php" aria-expanded="false">Kelola Data User</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-label">Kelola Data User</li>
